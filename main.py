...
if __name__ == '__main__':
    ...
    image_rouge = R_predit[:, :, 0]
    # Affichage de l'image en niveaux de gris représentant le canal rouge
    plt.imshow(image_rouge, cmap='gray', vmin=0, vmax=255)
    plt.title('Niveaux de rouge en niveaux de gris')
    plt.colorbar()
    plt.show()
